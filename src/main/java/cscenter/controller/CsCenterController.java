...
public class CsCenterController {
	...
	//메인 테스트
	/*
	 * @RequestMapping(value = "/mainnn") public String main(HttpServletRequest
	 * request) { HttpSession session = request.getSession(); // String id =
	 * (String) session.getAttribute("myuserCode"); //
	 * session.setAttribute("myuserCode", "인터헬씨"); return "main"; }
	 */
	...
	public String index(HttpServletRequest request, Model model) {
		...
		if(id != null) {
	    		int chatCount= chatService.allChatCount(id);
	...
	//가입 닉네임인지 확인 
		@RequestMapping(value="/cs/usercodeChk", method=RequestMethod.POST)
		@ResponseBody
		public String usercodeChk(@RequestBody String userCode) {
