...
public class AdverController {
	...
	public String adApp(@RequestParam(value="category") String category, 
		...
		if(category.equals("employer")) {
			System.out.println("employer입장");
			List<EmployerBoardVO> boardList = chatService.selectEb(myuserCode);
			model.addAttribute("boardList", boardList);
		}else if (category.equals("employee")) {
			List<WorkerBoardVO> boardList = chatService.selectWb(myuserCode);
			model.addAttribute("boardList", boardList);
		}
