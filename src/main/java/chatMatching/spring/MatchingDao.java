...
public interface MatchingDao {
	...
	public List<MatchingVo> selectErMatching2(String myUserCode, PageReady page); //내가 사장님일때 매칭 리스트 가져오기  
	public List<MatchingVo> selectEeMatching2(String myUserCode, PageReady page); //내가 알바생일때 매칭 리스트 가져오기  
	public void deleteMatching2(String matchingCode); //매칭취소시 삭제 
	public void updateMatchingCheck2(String matchingCode); //매칭 취소시 해당 게시글 매칭여부 N으로 변경
