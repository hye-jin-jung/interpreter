    ...
    <div class="content" style="margin-top: 30px;">
        <div class="nav-tabs-navigation" style="width: 1400px;">
            <div class="nav-tabs-wrapper" style="margin-top: 130px;">
                <ul id="tabs" class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/myBlogEr/${blogMaster}"
                            role="tab">IllNaNum</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="content-detail" style="display: flex; margin-left: 55px;">
            ...
            <div class="card card-nav-tabs" style="width: 400px; height: 500px;">
                ...
                <div class="card-body">
                    <h4 class="card-title">일나눔 ${blogMaster}님</h4>
                    <p class="card-text">${blogMaster}님이 일나눔으로서 받은 별점의 평균입니다.</p>
            ...
            <div class="card card-nav-tabs" style="width: 400px; height: 500px;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">일나눔 ${blogMaster}님을 소개합니다.</p>
                    <div class="intro">
            ...
            <div class="card card-nav-tabs" style="width: 400px; height: 500px;">
                ...
                <div class="card-body">
                    <h4 class="card-title">일나눔 ${blogMaster}님에 대한 평가</h4>
                    <p class="card-text">${blogMaster}님과 일한 일프로들이 남긴 평가입니다.</p>
                    <div class="review">
