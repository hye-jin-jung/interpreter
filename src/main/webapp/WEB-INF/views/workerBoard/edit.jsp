...
<html>
<head>
<title>${workerBoardVO.title}&nbsp 수정</title>
		...
		<form:form name="form" id="form" commandName="workerBoardVO" method="POST" onsubmit="return writeCheck()">
			<div class="form-group">
				...
				<table class="table" style="text-align:left;">
					<tr>
						<th><form:label path="wbCode">게시글코드</form:label></th>
						<td><form:input style="width: 30%;" class="form-control" path="wbCode" type="text" value="${wbCode }" readOnly="true"/>
						<form:errors path="userCode" /></td>
					</tr>		
		   			<tr>
						<th><form:label path="address">주소</form:label></th>
						<td><form:input class="form-control" path="address" type="text" id="roadFullAddr"  name="roadFullAddr" placeholder="주소를 입력하세요." disabled="true" /> 
					...
					<tr>
						...
						<td><form:input style="width: 30%;" class="form-control" type="text" id="datepicker3" placeholder="공고마감일" path="deadline" /> 
						<form:errors path="deadline" name="deadline"/>
						</td>
					</tr>
				</table>
						<textarea class="form-control" name="content" rows="13" cols="50" wrap="hard">${workerBoardVO.content}</textarea> 
