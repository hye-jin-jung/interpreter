		...
		<p class="mb-0">			
				 ...
				 <div class="updateInfo">
					...
					<div class="form-group has-success">
						<input type="password" id="password1" placeholder="새 비밀번호" class="password form-control form-control-success" required >
					</div>
					새 비밀번호 확인
					<div class="form-group has-success">
						<input type="password" id="password2" placeholder="새 비밀번호 확인" required class="password form-control form-control-success" required >
					</div>
