...
<script>
	...
	<div style="width: 60%; margin: auto;">
		<form method="post" action="freeWrite">
			...
			<input type="text" id="title" name="title" class="form-control form-control-success" style="width: 40%;" placeholder="제목을 입력하세요." required >
			<br> <br>
			...
			style="float: right;" onclick="location.href='freeList' " value="목록으로"> 
			<input type="button"
