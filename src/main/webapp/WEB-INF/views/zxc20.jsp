...
<body class="index-page sidebar-collapse">
  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-transparent" color-on-scroll="300">
    <div class="container" style="position:relative; z-index: 9999;" id="conId">
    	<div class="homelogo"> 
...
<a class="navbar-brand" onclick="delchk();" rel="tooltip" title="Coded by Creative Tim" data-placement="bottom">마이블로그
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navigation" style="width: 1530px;">
      	<div id="ulmagin">
        <ul class="navbar-nav">
<!--           <li class="nav-item">
          ...
          <li class="nav-item">
			...
			<a href="<c:url value="/login/login" />" class="btn btn-outline-default btn-round" id="loginBtn" type="button">로그인</a>
          </li>
        </ul>
        </div>
      </div>
