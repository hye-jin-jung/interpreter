...
<a class="navbar-brand" href="<c:url value="/workerBoard/list" />" rel="tooltip" title="구직게시판" data-placement="bottom">구직게시판</a>


<a class="navbar-brand" href="<c:url value="/employerBoard/list" />" rel="tooltip" title="구인게시판" data-placement="bottom">구인게시판</a>
