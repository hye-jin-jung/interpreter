...
<body>
	...
	<div style="margin-top: 50px;">
		<form action="${pageContext.request.contextPath}/admin/notice/insertContent" method="post">
			<table class="table">
				
				<tr>
					<th style="width: 100px;"><label style="color: black;">제목</label></th>
					<td>
						<input type="text" name="title" style="border: none; width:600px; height:50px; background-color:transparent;">
					</td>
				</tr>
				<tr>
					<th style="width: 100px;"><label style="color: black;">내용</label></th>
					<td>
						<textarea name="content" cols="100" rows="25" style="border: none; background-color:transparent; overflow: auto; text-align: justify"></textarea>
					</td>
				</tr>
				
				<tr>
					<td colspan="2" align="right"><input type="submit" value="등록" class="btn btn-outline-button btn-round"><a href="${pageContext.request.contextPath}/admin/notice" class="btn btn-outline-button btn-round">목록</a></td>
				</tr>
			</table>
		</form>	
	</div>
