...
<body>
	...
	<div style="margin-top: 50px;">
		<form action="${pageContext.request.contextPath}/admin/notice/updateContent" method="get">
			<table class="table">
				<tr>
					<th style="width: 100px;"><label style="color: black;">제목</label></th>
					<td>
						<input type="text" name="title" value="${post.title}" readonly="readonly" style="border: none; width:600px; height:50px; background-color:transparent;">
					</td>
				</tr>
				<tr>
					<th style="width: 100px;"><label style="color: black;">내용</label></th>
					<td>
						<textarea name="content" cols="100" rows="25" readonly="readonly" style="border: none; background-color:transparent; overflow: auto; text-align: justify">${post.content}</textarea>
					</td>
				</tr>
				<tr>
					<td align="left" >
						<a href="${pageContext.request.contextPath}/admin/notice" class="btn btn-outline-button btn-round">목록</a>
					</td>
					<td align="right">
						<input type="submit" class="btn btn-outline-button btn-round" value="수정">
						<a href="${pageContext.request.contextPath}/admin/notice/deleteContent?no=${post.no}" class="btn btn-outline-button btn-round">삭제</a>
					</td>
				</tr>
				<tr>
