...
<c:if test="${message == null}">
	...
	<div>
		<h1 style="padding-top: 10px; padding-left: 15%; padding-right: 15%; text-align: left;">회원 관리</h1>
	</div>
	<form>
	<div style="margin-left: 600px; margin-bottom: 25px;">
		<select id ="title" style="width: 110px; height:40px; margin-right: 10px; -webkit-appearance: menulist-button;">
			<option value="email">아이디</option>
			<option value="userCode">닉네임</option>
		</select>
		<input type="text" id="content" style="width: 450px; height:40px; margin-right: 10px;">
		<input type="button" class="btn btn-outline-button btn-round" id="searchUser" value="검색" >
	</div>
