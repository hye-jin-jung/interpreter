...
<body>
   ...
   <a id="BottomButton" href="#"><i class="fas fa-chevron-circle-down fa-2x "></i></a>
    ...
    <div id="mainimageblk">
        <nav id="navi">
            ...
            <div class="menu1">
                ...
                <ul>
                    ...
                    <li><a href='<c:url value="/myBlog/main/${blogMaster}" />'>마이블로그</a></li>
                </ul>
            </div>
        ...
        <div id="username">
            ...
            <div id="aa">
                ...
                <ul>
                    <li><a href='${pageContext.request.contextPath}/chatList" onclick="window.open(this.href,'
                            팝업창','width=430,height=600'); return false;'>채팅
                        </a></li>
    ...
    <br>
    <br>
    <h2 style="margin-left:405px;">뽐게 글 수정</h2>
    <br>
    <br>
    <br>

    <div style="width: 60%; margin: auto;">
        <form method="post" action="${pageContext.request.contextPath}/myBlog/modify" onsubmit="return goWrite();">
            <input type="hidden" name="showCode" value="${content.showCode}">
            <input type="text" id="title" name="title" class="form-control form-control-success" style="width: 40%;"
                value="${content.title}" required>
            <br> <br>
            <textarea id="summernote" name="content">${content.contents}</textarea>
