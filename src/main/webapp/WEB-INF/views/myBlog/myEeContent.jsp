...
function ondown(){   
 ...
 function ErSearch() {
   self.location = '${pageContext.request.contextPath}' + "/myBlog/myEeContent/" + '${blogMaster}' + '${pageMaker.makeQuery(1)}'
         + "&searchType="
        ...
        <div class="content-detail" style="width: 1100px;">
            ...
            <div class="search" style="float: right; display: flex; width: 350px; margin-top: 28px;">
                ...
                <input type="text" value="${scri.keyword}" name="keyword" id="keywordInput" onKeyDown="ondown()" 
                    style="background-color: transparent; border-color:translate; border: transparent;"
                    class="form-control" placeholder="Search...">
                <button class="btn btn-white btn-round btn-just-icon" id="searchBtn" onclick="ErSearch()">
            ...
            <div>
            	<button onclick="location.href='${pageContext.request.contextPath}/myBlog/myContent/${blogMaster}'" class="btn btn-primary btn-round" style="background-color: #848484; border: transparent; box-shadow: none;">IllNaNum</button>
            	<button onclick="location.href='${pageContext.request.contextPath}/myBlog/myEeContent/${blogMaster}'" class="btn btn-primary btn-round" style="background-color: #1ABC9C; border: transparent; box-shadow: none;"><i class="fas fa-check-circle" style="font-size: 20px;"></i>  IllPro</button>
            	<button onclick="location.href='${pageContext.request.contextPath}/myBlog/myFreeContent/${blogMaster}'" class="btn btn-primary btn-round" style="background-color: #848484; border: transparent; box-shadow: none;">FreeBoard</button>
            </div>
                        ...
                        <div class="card" style="width: 1100px;">
                            <div class="card-header card-header-primary">
                                <div style="float:left;">
                                    <h4 class="card-title ">IllPro</h4>
                                    <p class="card-category"> IllPro Gesipan</p>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <!-- 목록 시작 -->
                                            <c:forEach var="workerBoardList" items="${workerBoardList}" varStatus="loop">
                                                <tr>
                                                    <td>
                                                        <!-- DB에 char형식으로 저장돼있어서 .charAt(0) 붙여줘야함 -->
                                                        <c:if test="${workerBoardList.timeover eq 'Y'.charAt(0)}">
                                                            <img src="${pageContext.request.contextPath }/image/timeover.png"
                                                                width="25">
                                                        </c:if>
                                                    </td>
                                                    <td id="wbCode">${workerBoardList.wbCode}</td>
                                                    <td><a href="<c:url value="/workerBoard/read/${workerBoardList.wbCode}"/>">${workerBoardList.title}</a>
                                                    </td>
                                                    <td>${workerBoardList.regDate}</td>
                                                    <td>${workerBoardList.count}</td>
                                                </tr>
                                            </c:forEach>
                                            <!-- 목록 끝 -->
                                        </tbody>
                        ...
                        <div style="width: 1100px;">
                            <ul class="pagination">
                                <c:if test="${pageMaker.prev}">
                                    <li class="page-item">
                                        <a class="page-link"
                                            href="${pageContext.request.contextPath}/myBlog/myEeContent/${blogMaster}${pageMaker.makeSearch(pageMaker.startPage - 1)}"
                                            aria-label="Previous">
                                ...
                                <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
                                    <li class="page-item">
                                        <a class="page-link" href="${pageContext.request.contextPath}/myBlog/myEeContent/${blogMaster}${pageMaker.makeSearch(idx)}">${idx}</a>
                                    </li>
                                </c:forEach>
                                ...
                                <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
                                    <li class="page-item">
                                        <a class="page-link"
                                            href="${pageContext.request.contextPath}/myBlog/myEeContent/${blogMaster}${pageMaker.makeSearch(pageMaker.endPage + 1)}"
                                            aria-label="Next">
