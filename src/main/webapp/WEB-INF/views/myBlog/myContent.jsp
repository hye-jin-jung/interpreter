...
<script>
	...
	window.onpageshow = function (event) {
        ...
        function ondown(){   
         ...
         function EeSearch() {
           self.location = '${pageContext.request.contextPath}' + "/myBlog/myContent/" + '${blogMaster}' + '${pageMaker.makeQuery(1)}'
                 + "&searchType="
    ...
    <div class="content" style="margin-top: 30px;">
        ...
        <div class="content-detail" style="width: 1100px;">
            ...
            <div class="search" style="float: right; display: flex; width: 350px; margin-top: 28px;">
                ...
                <button class="btn btn-white btn-round btn-just-icon" id="searchBtn" onclick="EeSearch()">
            ...
            <div>
            	<button onclick="location.href='${pageContext.request.contextPath}/myBlog/myContent/${blogMaster}'" class="btn btn-primary btn-round" style="background-color: #1ABC9C; border: transparent; box-shadow: none;"><i class="fas fa-check-circle" style="font-size: 20px;"></i>  IllNaNum</button>
                        ...
                        <div class="card" style="width: 1100px;">
                            <div class="card-header card-header-primary">
                                <div style="float:left;">
                                    <h4 class="card-title ">IllNaNum</h4>
                                    <p class="card-category"> IllNaNum Gesipan</p>
                                </div>
                            </div>
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <c:if test="${employerBoard.matching eq 'Y'.charAt(0)}">
                                                            <img src="${pageContext.request.contextPath }/image/matching.png"
                                                                width="25">
                                                        </c:if>
                        ...
                        <div style="width: 1100px;">
                            <ul class="pagination">
                                <c:if test="${pageMaker.prev}">
                                    <li class="page-item">
                                        <a class="page-link"
                                            href="${pageContext.request.contextPath}/myBlog/myContent/${blogMaster}${pageMaker.makeSearch(pageMaker.startPage - 1)}"
                                            aria-label="Previous">
                                ...
                                <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
                                    <li class="page-item">
                                        <a class="page-link" href="${pageContext.request.contextPath}/myBlog/myContent/${blogMaster}${pageMaker.makeSearch(idx)}">${idx}</a>
                                    </li>
                                </c:forEach>
                                ...
                                <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
                                    <li class="page-item">
                                        <a class="page-link"
                                            href="${pageContext.request.contextPath}/myBlog/myContent/${blogMaster}${pageMaker.makeSearch(pageMaker.endPage + 1)}"
                                            aria-label="Next">
