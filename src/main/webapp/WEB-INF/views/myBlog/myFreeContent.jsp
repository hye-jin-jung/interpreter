...
function FreeSearch() {
	   self.location = '${pageContext.request.contextPath}' + "/myBlog/myFreeContent/" + '${blogMaster}' + '${pageMaker.makeQuery(1)}'
	         + "&searchType="
    ...
    <div class="content" style="margin-top: 30px;">
        ...
        <div class="content-detail" style="width: 1100px;">
            ...
            <div class="search" style="float: right; display: flex; width: 350px; margin-top: 28px;">
                ...
                <button class="btn btn-white btn-round btn-just-icon" id="searchBtn" onclick="FreeSearch()">
            ...
            <div>
            	...
            	<button onclick="location.href='${pageContext.request.contextPath}/myBlog/myEeContent/${blogMaster}'" class="btn btn-primary btn-round" style="background-color: #848484; border: transparent; box-shadow: none;">IllPro</button>
            	<button onclick="location.href='${pageContext.request.contextPath}/myBlog/myFreeContent/${blogMaster}'" class="btn btn-primary btn-round" style="background-color: #1ABC9C; border: transparent; box-shadow: none;"><i class="fas fa-check-circle" style="font-size: 20px;"></i>  FreeBoard</button>
            </div>
                        ...
                        <div class="card" style="width: 1100px;">
                            <div class="card-header card-header-primary">
                                <div style="float:left;">
                                    <h4 class="card-title ">FreeBoard</h4>
                                    <p class="card-category"> FreeBoard Gesipan</p>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${list}" var="list">
                                                <tr>
                                                    <td>${list.freecode}</td>
                                                    <td><a href="<c:url value="/freeList/read/${list.freecode}" />">${list.title}</a>
                                                    </td>
                                                    <td class="text-primary">${list.regdate}</td>
                                                    <td class="text-primary">${list.hit}</td>
                                                </tr>
                                            </c:forEach>
                                            <!-- 목록 끝 -->
                                        </tbody>
                        ...
                        <div style="width: 1100px;">
                            <ul class="pagination">
                                <c:if test="${pageMaker.prev}">
                                    <li class="page-item">
                                        <a class="page-link"
                                            href="${pageContext.request.contextPath}/myBlog/myFreeContent/${blogMaster}${pageMaker.makeSearch(pageMaker.startPage - 1)}"
                                            aria-label="Previous">
                                ...
                                <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
                                    <li class="page-item">
                                        <a class="page-link" href="${pageContext.request.contextPath}/myBlog/myFreeContent/${blogMaster}${pageMaker.makeSearch(idx)}">${idx}</a>
                                    </li>
                                </c:forEach>
                                ...
                                <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
                                    <li class="page-item">
                                        <a class="page-link"
                                            href="${pageContext.request.contextPath}/myBlog/myFreeContent/${blogMaster}${pageMaker.makeSearch(pageMaker.endPage + 1)}"
                                            aria-label="Next">
