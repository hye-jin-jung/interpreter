...
<%-- 					<tr>
						...
						<td><form:input style="width: 30%;" class="form-control" path="age" name="age"/>
					...
					<tr>
						...
						<textarea class="form-control" name="content" rows="13" cols="50" placeholder="내용을 입력하세요" wrap="hard"></textarea> 
			...
			<div style="text-align:center;">
				...
				<a type="button" class="btn btn-primary" style="background-color:#1ABC9C;border-color:#1ABC9C;"  
					href="<c:url value="/employerBoard/list" />">취소</a>
			</div>
		</form:form>
	</div>	
</div>
