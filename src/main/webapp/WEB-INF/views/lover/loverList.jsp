                ...
                <br><br><br><br><br><br>
					...
					<div class="loverList">
		                <div class="divide-line" >
		                    ...
		                    <span style="margin-top: 3px;font-size:16px;">내가 찜한 사용자</span>
		                </div>
		                	<div class="lover list" >
								<table class="type11">			
									<thead>
										<tr>
											<th scope="cols">찜한 사용자 리스트</th>
										</tr>
									</thead>
									<tbody>
									<c:forEach var="lover" items="${loverList}" varStatus="loop">
										<c:if test="${!empty loverList }">
											<tr>
												<td style="border-bottom: 1px solid #1ABC9C;">${lover.loverCode}
												<a id="blogGo" href="<c:url value="/myBlog/main/${lover.loverCode}"/>">님의 블로그 바로 가기</a></td>								
											</tr>
										</c:if>	
									</c:forEach>
										<c:if test="${empty loverList}">
